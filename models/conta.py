...
class Conta:
    ...
    def tranferir(self: object, destino: object, valor: float) -> None:
        """
        :param self: É a conta de origem de deseja tranferir.
        :param destino: É a conta que vai receber a transferencia. (No caso uma segunda conta)
        :param valor:  É o valor tranferido
        :return: Executa a Tranferencia de dinheiro
        """
